          ...
          >
            <motion.div
              ...
              className={cn(
                ...
                selected?.id === card.id
                  ? "rounded-lg cursor-pointer absolute inset-0 h-1/2 w-full md:w-1/2 m-auto z-50 flex justify-center items-center flex-wrap flex-col bg-slate-900 text-white"
                  : lastSelected?.id === card.id
                  ? "z-40 bg-slate-900 text-white rounded-xl h-full w-full"
                  : "bg-slate-900 text-white rounded-xl h-full w-full"
              )}
              layout
            >
